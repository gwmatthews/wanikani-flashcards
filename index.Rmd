...
I hope these might be genuinely useful in your studies! Each file linked to below contains printable pdf files that contain 15 cards per page, which can be printed two-sided and cut up to make sets of roughly business card-sized flashcards. Please read the instructions [in the repository](https://github.com/gwmatthews/wanikani-flashcards/) if you'd like to make your own sets of cards or improve the code. 
...
- [vocabulary 21](vocab-21.pdf)
- [vocabulary 21 a4 paper ](vocab-21-a4.pdf)
- [vocabulary 22](vocab-22.pdf)
- [vocabulary 22 a4 paper ](vocab-22-a4.pdf)
- [vocabulary 23](vocab-23.pdf)
- [vocabulary 23 a4 paper ](vocab-23-a4.pdf)
- [vocabulary 24](vocab-24.pdf)
- [vocabulary 24 a4 paper ](vocab-24-a4.pdf)
- [vocabulary 25](vocab-25.pdf)
- [vocabulary 25 a4 paper ](vocab-25-a4.pdf)
- [vocabulary 26](vocab-26.pdf)
- [vocabulary 26 a4 paper ](vocab-26-a4.pdf)
- [vocabulary 27](vocab-27.pdf)
- [vocabulary 27 a4 paper ](vocab-27-a4.pdf)
- [vocabulary 28](vocab-28.pdf)
- [vocabulary 28 a4 paper ](vocab-28-a4.pdf)
- [vocabulary 29](vocab-29.pdf)
- [vocabulary 29 a4 paper ](vocab-29-a4.pdf)
- [vocabulary 30](vocab-30.pdf)
- [vocabulary 30 a4 paper ](vocab-30-a4.pdf)
...
- [vocabulary 1-5 verbs](vocab-1-5-verbs.pdf)
- [vocabulary 1-5 verbs a4 paper ](vocab-1-5-verbs-a4.pdf)
- [vocabulary 6-10 verbs](vocab-6-10-verbs.pdf)
- [vocabulary 6-10 verbs a4 paper ](vocab-6-10-verbs-a4.pdf)
- [vocabulary 11-15 verbs](vocab-11-15-verbs.pdf)
- [vocabulary 11-15 verbs a4 paper ](vocab-11-15-verbs-a4.pdf)
- [vocabulary 16-20 verbs](vocab-16-20-verbs.pdf)
- [vocabulary 16-20 verbs a4 paper ](vocab-16-20-verbs-a4.pdf)
- [vocabulary 21-25 verbs](vocab-21-25-verbs.pdf)
- [vocabulary 21-25 verbs a4 paper ](vocab-21-25-verbs-a4.pdf)
- [vocabulary 26-30 verbs](vocab-26-30-verbs.pdf)
- [vocabulary 26-30 verbs a4 paper ](vocab-26-30-verbs-a4.pdf)

***

#### Custom sets

You can build your own sets if you run linux and have the right $LaTeX$ packages installed. See the [documentation](https://github.com/gwmatthews/wanikani-flashcards/blob/main/README.md) for how to. NOTE: some radicals may have blank faces -- this is because some Wanikani radicals are not displayed as glyphs in a font (characters) but as images. You can draw them in if they appear in any custom sets you might make. Hopefully there won't be too many! As an example, here are my current leeches -- those items that just don't seem to stick in my mind. Lately dealing with them has been kind of like playing whack-a-mole -- squash one and another comes back, sometimes with a friend. You can make these for a4 paper as well.
